...
Calling.prototype.set = function (name, value, settings) {
    ...
    this.settings.subscribe(
        jm.set(name, value, this.settings.getValue(), settings),
        {
            function: 'set',
            name
        }
...
Calling.prototype.push = function (name, value, settings) {
    const self = this
    this.settings.subscribe(
        jm.push(name, value, this.settings.getValue(), settings),
        {
            function: 'push',
            name
        }
...
Calling.prototype.unshift = function (name, value, settings) {
    const self = this
    this.settings.subscribe(
        jm.unshift(name, value, this.settings.getValue(), settings),
        {
            function: 'unshift',
            name
        }
...
Calling.prototype.delete = function (name, settings) {
    const self = this
    this.settings.subscribe(
        jm.delete(name, this.settings.getValue(), settings),
        {
            function: 'delete',
            name
        }
...
Calling.prototype.replace = function (name, value, settings) {
    const self = this
    this.settings.subscribe(
        jm.replace(name, value, this.settings.getValue(), settings),
        {
            function: 'replace',
            name
        }
...
Calling.prototype.change = function (name, value) {
    this.settings.subscribe(
        jm.change(name, value, this.settings.getValue(), settings),
        {
            function: 'change',
            name
        }
