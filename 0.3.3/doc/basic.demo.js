...
/******/ 	__webpack_require__.p = "/calling/0.3.3";
/******/
...
var Calling = __webpack_require__("./lib/index.js");
        ...
        value: function render() {
            ...
            return __webpack_require__("./node_modules/react/index.js").createElement(
                ...
                __webpack_require__("./node_modules/react/index.js").createElement(
                    ...
                    null,
                    'state:',
                    JSON.stringify(self.state, null, 4)
                ),
                __webpack_require__("./node_modules/react/index.js").createElement(
                    'pre',
                    null,
                ...
                __webpack_require__("./node_modules/react/index.js").createElement(
                    ...
                    {
                        onClick: function onClick() {
                            ca.delete('list[{name:"nico"}]');
                        }
                    },
                    'delete list[{name:"nico"}]'
                ),
                ' ',
                __webpack_require__("./node_modules/react/index.js").createElement(
                    'button',
                ...
                __webpack_require__("./node_modules/react/index.js").createElement(
                    'code',
                    null,
                    'get(\'list[{name:"nimo"}].age\')',
                    ' // ',
                    ca.get('list[{name:"nimo"}].age')
                ),
                __webpack_require__("./node_modules/react/index.js").createElement('hr', null),
                __webpack_require__("./node_modules/react/index.js").createElement(
                    'code',
                    ...
                    ' // ',
                    JSON.stringify(ca.getAll('list[{name:"nimo"}]'))
                )
            );
        }
    }], [{
...
/*ONFACE-DEL*/Basic = __webpack_require__("./node_modules/react-hot-loader/index.js").hot(module)(Basic);
...
module.exports = function createReact(UserComponent, settings) {
    return function (_Component) {
        _inherits(CallingReact, _Component);

        function CallingReact(props) {
            _classCallCheck(this, CallingReact);

            var _this = _possibleConstructorReturn(this, (CallingReact.__proto__ || Object.getPrototypeOf(CallingReact)).call(this, props));

            var self = _this;
            settings = (0, _safeExtend2.default)(true, { name: 'store' }, settings);
            if (settings.name) {
                self.state = UserComponent.defaultProps[settings.name];
            } else {
                self.state = UserComponent.defaultProps;
            }
            var useCache = /cacache/.test(location.search);
            if (useCache && localStorage.getItem('calling_cache')) {
                self.state = JSON.parse(localStorage.getItem('calling_cache'));
            }
            self.ca = new _index2.default({
        ...
        _createClass(CallingReact, [{
            key: "render",
            value: function render() {
                var self = this;
                var cloneState = _safeExtend2.default.clone(self.state);
                var store = {};
                if (settings.name) {
                ...
                return __webpack_require__("./node_modules/react/index.js").createElement(UserComponent, _extends({}, store, {
                    ca: self.ca,
...
var jm = __webpack_require__("./node_modules/json-modif/lib/index.js");
var extend = __webpack_require__("./node_modules/safe-extend/index.js");
var delayEach = __webpack_require__("./node_modules/delayeach/index.js");
var createReact = __webpack_require__("./lib/createReact.js");

var Calling = function Calling(settings) {
...
Calling.prototype.action = function (name, payload) {
    ...
    if (_typeof(settings.actions) !== 'object') {
        return;
    }
    if (typeof settings.actions[name] === 'function') {
        settings.actions[name](payload, self);
    }
};
Calling.prototype.emitChange = function (data) {
    var self = this;
    var onChangeOutput = self.settings.onChange(data);
    var outputIsPromise = (typeof onChangeOutput === 'undefined' ? 'undefined' : _typeof(onChangeOutput)) === 'object' && onChangeOutput.constructor === Promise;
    if (outputIsPromise) {
...
module.exports = function set(attrs, value, data, settings) {
    ...
    var queryResult = (0, _query2.default)(attrs, (0, _safeExtend2.default)(true, data, (0, _create2.default)(attrs, '')), settings);
